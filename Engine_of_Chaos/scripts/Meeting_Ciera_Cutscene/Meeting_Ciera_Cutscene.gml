function Meeting_Ciera_Cutscene() {
	...
	switch(state){
	    ...
	    case 4:
	        state += 1;
	        _max.depth += 2;
	        Move_Character(_max,"Up",.5,6);//character,direction,tiles,speed
	    break;
		 case 5:
	        state += 1;
	        Move_Character(_max,"Up",1,6);
	    break;
		case 6:
	        state += 1;
	        Move_Character(_max,"Up",1,6);
	    ...
	    case 49:
	        state += 1;
	        Perform_Jump(_jason,1,1);
	        Move_Character(_max,"Right",1,3,"Right",-1);
	    break;
		case 50:
	        state += 1;
	         Move_Character(_max,"Right",1,3,"Right",-1,false);
	    break;
	    case 51:
	        state += 1;
	        Move_Character(_jason,"Right",.5,6);
		...
		case 52:
	        state += 1;
	        Move_Character(_jason,"Right",1,6);
	    break;
		case 53:
	        state += 1;
	        Move_Character(_jason,"Right",1,6);
	    ...
	    case 54:
	        ...
	        Move_Character(_jason,"Left",.5,3,"Right");
	    break;
		 case 55:
	        state += 1;
	        Move_Character(_jason,"Left",1,3,"Right");
