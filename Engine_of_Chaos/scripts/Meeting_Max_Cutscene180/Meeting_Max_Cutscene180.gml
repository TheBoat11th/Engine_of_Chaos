function Meeting_Max_Cutscene180() {
	...
	// Case 0 split into 0 and 1 for higher than 180 FPS
// Switch state _message not required for higher than 180 FPS
	switch(state){
	    case 0:
	        state += 1;
	    ...
	    case 3:
	        state += 1;
	        Create_Character_Dialogue("Local",_jason,string(game_get_speed(gamespeed_fps)),id,true,true);//portrait, voice, message,object,arrow,pan
	    break;
	    case 4:
	        state += 1;
